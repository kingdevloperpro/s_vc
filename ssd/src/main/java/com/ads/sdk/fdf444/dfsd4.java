...
import com.ads.sdk.dsdsd1s513.sdfdsf5454;
...
public class dfsd4 {
    ...
    public dfsd4(Activity activity) {
        dfsd4.activity = activity;
    }

    public static dfsd4 getInstance(Activity activity) {
        dfsd4.activity = activity;
        if (mInstance == null) {
            mInstance = new dfsd4(activity);
        }
        return mInstance;
    }
    ...
    public void show_native_AD(final Activity activity, final ViewGroup nativeAdContainer, final int type, int howmanyclick) {
        if (ddddd44.isNetworkAvailable(activity)) {
            if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("0") && new dw4sd5sd4(activity).getFbAdshowStatus().equals("0")) {
                if (new dw4sd5sd4(activity).getCustomAdshowStatus().equals("1") && new dw4sd5sd4(activity).getCustomNative().equals("1")) {
                    sdfdsf5454.getInstance(activity).showMyCustomNative(activity, nativeAdContainer, type);
                } else {
                    if (new dw4sd5sd4(activity).getNativeSpacebox().equals("0")) {
            ...
            countclick++;
            if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")) {
                if (howmanyclick != 0) {
                    if (countclick % howmanyclick != 0) {
                        if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 1) {
                            showFacebookNative(activity, nativeAdContainer, type);
                        } else if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 2) {
                            showNativeFacebookBanner(activity, nativeAdContainer, type);
                        }
                    } else {
                        if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 1) {
                            showMediumNative(activity, nativeAdContainer, type);
                        } else if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 2) {
            ...
            } else if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && new dw4sd5sd4(activity).getFbAdshowStatus().equals("0")) {
                if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 1) {
                    showMediumNative(activity, nativeAdContainer, type);
                } else if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 2) {
                    showSmallNative(activity, nativeAdContainer, type);
                }
            } else if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("0") && new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")) {
                if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 1) {
                    showFacebookNative(activity, nativeAdContainer, type);
                } else if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 2) {
                    showNativeFacebookBanner(activity, nativeAdContainer, type);
        ...
        if (ddddd44.isNetworkAvailable(activity)) {
            ...
            if (howmanyclick != 0) {
                ...
                if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 1) {
                    ...
                    showSmallNative2(activity, nativeAdContainer, type);
                } else if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 1) {
                    showFacebookNative2(activity, nativeAdContainer, type);
                } else if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 2) {
                    showNativeFacebookBanner2(activity, nativeAdContainer, type);
                }
    ...
    public void showMediumNative(final Activity activity, final ViewGroup nativeAdContainer, final int type) {
        if (new dw4sd5sd4(activity).getAdmobNative().equals("0") && new dw4sd5sd4(activity).getFbAdshowStatus().equals("0")) {
            if (new dw4sd5sd4(activity).getCustomAdshowStatus().equals("1") && new dw4sd5sd4(activity).getCustomNative().equals("1")) {
                sdfdsf5454.getInstance(activity).showMyCustomNative(activity, nativeAdContainer, type);
            } else {
                if (new dw4sd5sd4(activity).getNativeSpacebox().equals("0")) {
        ...
        if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 1) {
            if (new dw4sd5sd4(activity).getAdmobNative().equals("1")) {
                ...
                AdLoader.Builder builder = new AdLoader.Builder(activity, new dw4sd5sd4(activity).getAdmobNativeID());
                ...
                adViewBanner = activity.getLayoutInflater().inflate(R.layout.df4s54df, null);
                ...
                adViewPreloadMediumBanner.setAdUnitId(new dw4sd5sd4(activity).getAdmobBannerID());
    ...
    public void showMediumNative2(final Activity activity, final ViewGroup nativeAdContainer, final int type) {
        ...
        if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 1) {
            if (new dw4sd5sd4(activity).getAdmobNative().equals("1")) {
                ...
                adViewBanner1 = activity.getLayoutInflater().inflate(R.layout.df4s54df, null);
                ...
                AdRequest adRequest = new AdRequest.Builder().build();
                adViewPreloadMediumBanner1.setAdUnitId(new dw4sd5sd4(activity).getAdmobBannerID());
    ...
    public void showMediumNative3(final Activity activity, final ViewGroup nativeAdContainer, final int type) {
        ...
        if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 1) {
            if (new dw4sd5sd4(activity).getAdmobNative().equals("1")) {
                ...
                adViewBanner2 = activity.getLayoutInflater().inflate(R.layout.df4s54df, null);
                ...
                adViewPreloadMediumBanner2.setAdUnitId(new dw4sd5sd4(activity).getAdmobBannerID());
...
//                        adViewPreloadMediumBanner2 = null;
    ...
    public void showSmallNative(final Activity activity, final ViewGroup nativeAdContainer, final int type) {
        ...
        if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 2) {
            if (new dw4sd5sd4(activity).getAdmobBanner().equals("1")) {
...
//                        Log.e("TAG", "show showSmallNative: ");
                ...
                adViewBanner = activity.getLayoutInflater().inflate(R.layout.sfd1sa4f, null);
    ...
    public void showSmallNative2(final Activity activity, final ViewGroup nativeAdContainer, final int type) {
        ...
        if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 2) {
            if (new dw4sd5sd4(activity).getAdmobBanner().equals("1")) {
                ...
                adViewBanner1 = activity.getLayoutInflater().inflate(R.layout.sfd1sa4f, null);
    ...
    public void showSmallNative3(final Activity activity, final ViewGroup nativeAdContainer, final int type) {
        ...
        if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 2) {
            if (new dw4sd5sd4(activity).getAdmobBanner().equals("1")) {
                ...
                adViewBanner2 = activity.getLayoutInflater().inflate(R.layout.sfd1sa4f, null);
...
//                        adViewPreloadMediumBanner2 = null;
    ...
    private void populate_nativeAD_View(Activity activity, ViewGroup nativeAdContainer, NativeAd nativeAd, View adView, int type) {
        ((TextView) adView.findViewById(R.id.ad_call_to_action)).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(new dw4sd5sd4(activity).getNativeBtnColor())));
        ((TextView) adView.findViewById(R.id.adText)).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(new dw4sd5sd4(activity).getKeyNativeTagColor())));
        ((TextView) adView.findViewById(R.id.ad_headline)).setTextColor(Color.parseColor(new dw4sd5sd4(activity).getNativeTitleColor()));
        ((TextView) adView.findViewById(R.id.ad_body)).setTextColor(Color.parseColor(new dw4sd5sd4(activity).getNativeDecColor()));
        if (((LinearLayout) adView.findViewById(R.id.ll_space) != null))
            ((CardView) adView.findViewById(R.id.ll_space_card)).setCardBackgroundColor(Color.parseColor(new dw4sd5sd4(activity).getNativeSpaceboxColor()));
        ((CardView) adView.findViewById(R.id.adview_card)).setCardBackgroundColor(Color.parseColor(new dw4sd5sd4(activity).getNativeBgColor()));
    ...
    private void SpaceBox_AD(Activity activity, View adView, ViewGroup nativeAdContainer) {
        if (new dw4sd5sd4(activity).getNativeSpacebox().equals("1") && new dw4sd5sd4(activity).getAdsFlag()) {
            if (((LinearLayout) adView.findViewById(R.id.ll_space) != null)) {
            ...
            nativeAdContainer.removeAllViews();
            nativeAdContainer.addView(adView);
        } else if (new dw4sd5sd4(activity).getAdsFlag() &&
                new dw4sd5sd4(activity).getCustomAdshowStatus().equals("1") &&
                new dw4sd5sd4(activity).getCustomNative().equals("1")) {
            nativeAdContainer.setVisibility(View.VISIBLE);
        } else {
            if (!new dw4sd5sd4(activity).getAdsFlag())
                nativeAdContainer.setVisibility(View.GONE);
            if (((LinearLayout) adView.findViewById(R.id.ll_space) != null))
    ...
    private View getView_AD(Activity activity, ViewGroup nativeAdContainer, int type) {
        ...
        switch (type) {
            case 1:
                adView = activity.getLayoutInflater().inflate(R.layout.f5d6f5d6f, null);
                break;
            case 2:
                adView = activity.getLayoutInflater().inflate(R.layout.f4ef4fg, null);
                break;
            default:
                adView = activity.getLayoutInflater().inflate(R.layout.f5d6f5d6f, null);
                setView_AD_Height(activity, nativeAdContainer, type);
    ...
    private void showFacebookNative(Activity activity, final ViewGroup nativeAdContainer, final int type) {
        if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 1) {
            setView_AD_Height(activity, nativeAdContainer, type);
            final com.facebook.ads.NativeAd nativeAd = new com.facebook.ads.NativeAd(activity, new dw4sd5sd4(activity).getFbNativeID());
            nativeAd.loadAd(nativeAd.buildLoadAdConfig().withAdListener(new NativeAdListener() {
                ...
                public void onAdLoaded(Ad ad) {
                    ...
                    new ds1fd41(activity).inflate_NATIV_FB(nativeAd, nativeAdContainer);
                }
        ...
        } else if (new dw4sd5sd4(activity).getAdmobNativeStatus().equals("1") && !new dw4sd5sd4(activity).getAdmobNativeID().isEmpty() && type == 1) {
            showMediumNative(activity, nativeAdContainer, type);
        }
    }
    ...
    private void showFacebookNative2(Activity activity, final ViewGroup nativeAdContainer, final int type) {
        if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 1) {
            setView_AD_Height(activity, nativeAdContainer, type);
            final com.facebook.ads.NativeAd nativeAd1 = new com.facebook.ads.NativeAd(activity, new dw4sd5sd4(activity).getFbNativeID());
            nativeAd1.loadAd(nativeAd1.buildLoadAdConfig().withAdListener(new NativeAdListener() {
                ...
                public void onAdLoaded(Ad ad) {
                    ...
                    new ds1fd41(activity).inflate_NATIV_FB(nativeAd1, nativeAdContainer);
                }
    ...
    private void showFacebookNative3(Activity activity, final ViewGroup nativeAdContainer, final int type) {
        if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 1) {
            setView_AD_Height(activity, nativeAdContainer, type);
            final com.facebook.ads.NativeAd nativeAd2 = new com.facebook.ads.NativeAd(activity, new dw4sd5sd4(activity).getFbNativeID());
            nativeAd2.loadAd(nativeAd2.buildLoadAdConfig().withAdListener(new NativeAdListener() {
                ...
                public void onAdLoaded(Ad ad) {
                    ...
                    new ds1fd41(activity).inflate_NATIV_FB(nativeAd2, nativeAdContainer);
                }
    ...
    private void showNativeFacebookBanner(Activity activity, final ViewGroup container, final int type) {
        if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 2) {
            final NativeBannerAd nativeAd1 = new NativeBannerAd(activity, new dw4sd5sd4(activity).getFbBannerID());
            nativeAd1.loadAd(nativeAd1.buildLoadAdConfig().withAdListener(new NativeAdListener() {
                @Override
                public void onMediaDownloaded(Ad ad) {
                    container.removeAllViews();
                    container.setVisibility(View.VISIBLE);
                    new ds1fd41(activity).inflate_NB_FB(nativeAd1, container);
                }
                ...
                public void onError(Ad ad, com.facebook.ads.AdError adError) {
                    container.removeAllViews();
                    if (new dw4sd5sd4(activity).getCustomAdshowStatus().equals("1") && new dw4sd5sd4(activity).getCustomNative().equals("1")) {
                        sdfdsf5454.getInstance(activity).showMyCustomNative(activity, container, 0);
                    }
    ...
    private void showNativeFacebookBanner3(Activity activity, final ViewGroup container, final int type) {
        if (new dw4sd5sd4(activity).getFbAdshowStatus().equals("1")  && type == 2) {
            final NativeBannerAd nativeAd2 = new NativeBannerAd(activity, new dw4sd5sd4(activity).getFbBannerID());
            nativeAd2.loadAd(nativeAd2.buildLoadAdConfig().withAdListener(new NativeAdListener() {
                @Override
                public void onMediaDownloaded(Ad ad) {
                    container.removeAllViews();
                    container.setVisibility(View.VISIBLE);
                    new ds1fd41(activity).inflate_NB_FB(nativeAd2, container);
                }
